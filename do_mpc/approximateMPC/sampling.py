...
def approx_mpc_sampling_plan_box(n_samples,lbx,ubx,lbu,ubu,data_dir='./sampling',overwrite=True):
    # Samples
...
def approx_mpc_sampling_plan_func(n_samples,gen_x0,gen_u_prev,data_dir='./sampling',overwrite=True):
    # Samples
    data_dir=Path(data_dir)
    sampling_plan_name = 'sampling_plan' + '_n' + str(n_samples)
    #overwrite = True
...
#####################################################
# %% MPC
def approx_mpc_open_loop_sampling(mpc,data_dir='./sampling',n_samples=2000,overwrite_sampler=True):
    # %% Config
    #####################################################
