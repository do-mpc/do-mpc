...
class LQR:
    ...
    **Configuration and setup:**
    ...
    def __init__(self,model):
        ...
        assert isinstance(model, LinearModel), 'LQR can only be used with linear models. Initialize the model with type LinearModel.'
        assert model.flags['setup'] == True, 'Model for LQR was not setup. After the complete model creation call LinearModel.setup().'
    ...
    def set_rterm(self,delR):
        ...
        # K = self.discrete_gain(self.A_rated, self.B_rated)
        # return K
    ...
    def set_objective(self, Q = None, R = None, P = None):
        """Sets the cost matrix for the Optimal Control Problem.
        
        This method sets the cost matrices of inputs and states for the given problem.
        ...
        **Infinite Horizon**:
        ...
        :param R: Input cost matrix (optional)
