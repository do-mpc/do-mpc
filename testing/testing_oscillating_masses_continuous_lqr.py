...
class TestOscillatingMassesContinuousLQR(unittest.TestCase):
    def setUp(self):
        default_path = copy.deepcopy(sys.path)
        
        sys.path.append('../examples/lqr_examples/oscillating_masses_continuous_lqr/')
    ...
    def test_SX(self):
        ...
        self.oscillating_masses_continuous_lqr('SX')
        
    def test_MX(self):
        print('Testing MX implementation')
        self.oscillating_masses_continuous_lqr('MX')
        
    def oscillating_masses_continuous_lqr(self, symvar_type):
        """
        ...
        """
        ref = do_mpc.data.load_results('./results/results_oscillatingMasses_continuous_LQR.pkl')
