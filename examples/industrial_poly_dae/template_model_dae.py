...
def template_model(symvar_type='SX'):
    ...
    T_adiab =     model.set_variable('_z', 'T_adiab')
    ...
    model.set_alg('alg_T_adiab', T_adiab - T_R - (delH_R / c_pR) * (m_A / m_ges))

    model.set_meas("m_W", m_W)
    model.set_meas("m_A", m_A)
    model.set_meas("m_P", m_P)
    model.set_meas("T_R", T_R)
    model.set_meas("T_S", T_S)
    model.set_meas("Tout_M", Tout_M)
    model.set_meas("T_EK", T_EK)
    model.set_meas("Tout_AWT", Tout_AWT)
    model.set_meas("accum_monom", accum_monom)
    model.set_meas('T_adiab', T_adiab)
    # Build the model
    model.setup()
