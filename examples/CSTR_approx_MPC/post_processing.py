...
label_lines = (
    sim_graphics.result_lines["_x", "C_a"] + sim_graphics.result_lines["_x", "C_b"]
)
ax[0].legend(label_lines, ["C_a", "C_b"])
label_lines = (
    sim_graphics.result_lines["_x", "T_R"] + sim_graphics.result_lines["_x", "T_K"]
)
...
label_lines = (
    mpc_graphics.result_lines["_x", "C_a"] + mpc_graphics.result_lines["_x", "C_b"]
)
ax[0].legend(label_lines, ["C_a", "C_b"])
label_lines = (
    mpc_graphics.result_lines["_x", "T_R"] + mpc_graphics.result_lines["_x", "T_K"]
)
ax[1].legend(label_lines, ["T_R", "T_K"])
