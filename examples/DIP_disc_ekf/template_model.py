...
def template_model(obstacles, symvar_type='SX'):
    ...
    model.set_rhs('pos', pos + delta_t*dpos)
    model.set_rhs('theta', theta +delta_t*dtheta)
    model.set_rhs('dpos', dpos+delta_t*ddpos)
    model.set_rhs('dtheta', dtheta + delta_t*ddtheta)
