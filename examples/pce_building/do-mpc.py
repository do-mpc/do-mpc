...
GENERATE_PCE = 1
if GENERATE_PCE == 1:
    execfile("embedded_PCE.py")

A_extended, B_extended, E_extended, pce_terms = embedded_PCE.expanded_building()
...
model_1 = template_model.model(A_extended, B_extended, E_extended, [], pce_terms)
